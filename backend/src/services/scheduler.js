...
import { birthdayNotifications, dailyWellnessNotifications, holidayNotifications, damUsageNotifications, mondayAlignmentNotifications } from "./notificationContent.js";
...
export async function runNotificationScan(date = new Date()) {
  ...
  const candidates = [
    ...
    ...mondayAlignmentNotifications(db, date),
