...
export default function ProfileImageUpload({ open, onOpenChange, onUpload, isLoading }) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-2xl">Update Profile Picture</DialogTitle>
        </DialogHeader>
          ...
          {!preview ? (
            ...
            <AnimatePresence>
              <motion.div
                ...
                className="relative"
              >
                <div className="relative w-64 h-64 mx-auto rounded-full overflow-hidden border-4 border-gray-200">
                  <img
                    src={preview}
                    alt="Preview"
